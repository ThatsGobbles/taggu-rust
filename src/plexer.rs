...
pub fn plex<'a, I>(metadata: &Metadata, selected_item_names: I) -> Vec<PlexRecord>
...
pub fn plex_item_format<'a, I>(imf: &ItemMetaFormat, selected_item_names: I) -> Vec<PlexRecord>
where I: IntoIterator<Item = &'a str>
{
    match *imf {
...
fn plex_meta_block_seq<'a, I>(mb_seq: &MetaBlockSeq, selected_item_names: I) -> Vec<PlexRecord>
where I: IntoIterator<Item = &'a str>
{
...
fn plex_meta_block_map<'a, I>(mb_map: &MetaBlockMap, selected_item_names: I) -> Vec<PlexRecord>
where I: IntoIterator<Item = &'a str>
{
    // Growable vector of results.
    let mut results: Vec<PlexRecord> = vec![];
